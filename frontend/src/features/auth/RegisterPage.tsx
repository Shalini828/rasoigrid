...
export const RegisterPage: React.FC = () => {
   ...
   * 3. Redirect to role-specific workspace
   * =========================================================
   */
  const handleSubmit = async (
    ...
    try {
      ...
      if (!storedUser) {
        throw new Error(
          'Account created, but authentication could not be completed.'
        );
      }
      ...
      /*
       * STEP 4:
       * Send user to the correct workspace.
       */
      const destination =
        getRoleBasedRoute(user.role);
